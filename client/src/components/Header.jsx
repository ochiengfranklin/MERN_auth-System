...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
       ...
       font-medium mb-2'>Hey {userData ? userData.name : 'Developer'}! <img className='w-8 aspect-square' src={assets.handwave} alt="" />
       </h1>
       <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome to our App</h2>
       <p className='mb-8 mx-w-md'>Let's start with a quick product tour and we will have you up 
